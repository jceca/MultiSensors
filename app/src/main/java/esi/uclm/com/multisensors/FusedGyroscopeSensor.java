...
public class FusedGyroscopeSensor implements SensorEventListener {
     ...
     *
     * @paramgravitySubject the gravity subject.
     * @paramgyroscopeSubject the gyroscope subject.
     * @parammagneticSubject the magnetic subject.
     */
     ...
     * @paramThe device orientation.
     * @seehttp://en.wikipedia.org/wiki/Rotation_matrix
     */
    ...
    private void calculateFusedOrientation() {
        ...
        /* Overwrite gyro matrix & orientation to compensate drift */
